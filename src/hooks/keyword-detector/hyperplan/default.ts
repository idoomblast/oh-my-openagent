...
7. MANDATORY: hand the bundle to the \`prometheus\` agent via \`task(subagent_type="prometheus", ...)\` — the planner agent owns sequencing, parallelization, and verification gates
